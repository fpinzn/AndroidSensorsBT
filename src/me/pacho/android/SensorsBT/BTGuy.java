...
public class BTGuy {
    // Debugging
    private static final String TAG = "BTGuy";
     ...
     */
    public BTGuy(Context context, Handler handler) {
    ...
    private class ConnectedThread extends Thread {
          ...
          /*  Log.i(TAG, "BEGIN mConnectedThread");
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(SensorsBT.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
          /*  try {
                ...
                mHandler.obtainMessage(SensorsBT.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
